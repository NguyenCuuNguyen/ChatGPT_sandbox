...
def upload_file(files):
    ...
    # index = construct_index("../../../../nguyencuu/AppData/Local/Temp/gradio/aca317d818f5d5a8e381adeff7d8df5abf24322e")
    return file_paths
...
def main():
    ...
    # index = construct_index("data")#, file_paths)
